...
class StudentProfileController extends Controller
{
    public function myProfile()
    {
        ...
        $data['courese_count'] = Order::where('student_id',$userId)->groupby('course_id')->count();
        $data['orders_reviews_count'] = Order::where('student_id',$userId)->count();
        $data['exams_count'] = UserExam::where('student_id',$userId)->count();
        $data['messages_count'] = Chat::where('sender_id',$userId)->groupby('sender_id')->count();

        return view('StudentAdmin.pages.home',compact('data'));
    }
