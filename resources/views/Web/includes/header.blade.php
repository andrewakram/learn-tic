    ...
    <div class="container-fluid">
        ...
        <nav>
            ...
            <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                <li>
                    <a href="{{route('home')}}"><span class="title">{{ trans('lang.home') }}</span></a>
                </li>

                <li>
                    <a href="{{route('courses')}}"><span class="title">{{ trans('lang.courses') }}</span></a>
                    <!-- Level Two-->
                ...
                <li>
                    ...
                    <a href="{{route('blogs')}}"><span class="title">{{ trans('lang.blogs') }}</span></a>
                            ...
                            <li>
                                ...
                                <ul class="dropdown_content login_drop">
                                    ...
                                    <li class="list_content">
                                        ...
                                        <a href="{{route('student_login')}}" class="btn btn-thm cart_btns"> {{ trans('lang.login_student') }} </a>
                                        <a href="{{route('instructor_login')}}" class="btn btn-thm3 checkout_btns">{{ trans('lang.login_teacher') }} </a>
                                    </li>
