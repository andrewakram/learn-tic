            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3 text-center">
                    <div class="breadcrumb_content">
                        <h4 class="breadcrumb_title"> {{ trans('lang.login_instructor') }} </h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">{{ trans('lang.home') }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('lang.login_instructor') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-lg-6 offset-lg-3">
                    <div class="login_form inner_page">
                        <div class="heading">
                            ...
                            <p class="text-center">{{ trans('lang.have_account') }} <a class="text-thm sign_up"
                                          href="{{route('instructor_register')}}">{{ trans('lang.sign_up') }}</a></p>
                        </div>
                        <form  action="{{route('instructorDoLogin')}}" method="post">
                            @csrf
