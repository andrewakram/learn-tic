			...
			<div class="row">
				<div class="col-xl-6 offset-xl-3 text-center">
					<div class="breadcrumb_content">
						<h4 class="breadcrumb_title">Logın For Student</h4>
						<ol class="breadcrumb">
						    <li class="breadcrumb-item"><a href="#">Home</a></li>
						    <li class="breadcrumb-item active" aria-current="page">Logın For Student</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="login_form inner_page">
						<form action="#">
							<div class="heading">
								...
								<p class="text-center">Don't have an account? <a class="text-thm sign_up" href="{{route('student_register')}}">Sign Up!</a></p>
							</div>
