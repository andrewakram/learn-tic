            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.blogs')}}" class="text-muted text-hover-primary">
                                المقالات</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                ...
                <!--begin::Aside column-->
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::date-->
                                <input class="form-control"  type="date" name="date" placeholder="Pick date &amp; time" />
                                <!--end::date-->
                            </div>
                            <!--end::Card body-->
                        </div>
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" required name="title_ar" class="form-control mb-2"
                                                       placeholder="عنوان المقال (بالعربي)" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" required name="title_en" class="form-control mb-2"
                                                       placeholder="عنوان المقال (بالإنجليزي)" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <textarea  id="editor1" name="description_ar"
                                                           value="" placeholder="وصف المقال (بالعربي)"></textarea>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <textarea  id="editor2" name="description_en"
                                                           value="" placeholder="وصف المقال (بالإنجليزي)"></textarea>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            {{--                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>--}}
                                            <!--end::Description-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('admin.blogs')}}" id="kt_ecommerce_add_product_cancel"
