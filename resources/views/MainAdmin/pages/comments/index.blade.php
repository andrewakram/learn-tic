            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class=" fs-3 fw-bold my-1 ms-1" style="color: #5482d5">الأقسام</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
                ...
                <div class="d-flex align-items-center py-1">
                    <!--begin::Wrapper-->
                    <!--begin::Button-->
                    <a href="{{route('admin.comments.create')}}" class="btn btn-sm btn-success"
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                <th class="w-10px pe-2">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid  checkboxes">
                                ...
                                <th class=" min-w-100px">التعليق (عربي)</th>
                                <th class=" min-w-100px">التعليق (إنجليزي)</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="delete_multi_form" method="post" action="{{route('admin.comments.deleteMulti')}}">
                        @csrf
        ...
        $(document).ready(function () {
            ...
            $("#kt_ecommerce_products_table").DataTable({
                ...
                "columns": [
                    ...
                    {"data": "body_ar", "searchable": true, "orderable": false},
                    {"data": "body_en", "searchable": true, "orderable": false},
