                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">إسم  (عربي)</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="title_ar" class="form-control mb-2"
                                                       placeholder="إسم  (عربي)" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">إسم  (إنجليزي)</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="title_en" class="form-control mb-2"
                                                       placeholder="إسم  (إنجليزي)" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            <div class="mb-10 fv-row">
                                                ...
                                                <textarea id="editor1" name="body_ar"
                                                          value=""
                                                          placeholder="التعليق  (بالعربي)"></textarea>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <textarea id="editor2" name="body_en"
                                                          value=""
                                                          placeholder=" التعليق (بالإنجليزي)"></textarea>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            {{--        <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>--}}
                                            <!--end::Description-->
