            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class=" fs-3 fw-bold my-1 ms-1" style="color: #5482d5">المدن</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="delete_multi_form" method="post" action="{{route('admin.cities.deleteMulti')}}">
                        @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#kt_ecommerce_products_table").DataTable({
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                                    <td style="text-align: right"><p>عنوان التقرير : المدن</p>' +
                ...
                ajax: '{{ route('admin.cities.datatable') }}',
                "columns": [
