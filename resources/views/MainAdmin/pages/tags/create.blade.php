            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.tags')}}" class="text-muted text-hover-primary">
                                Tags</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                ...
                @csrf
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" required name="title_ar" class="form-control mb-2"
                                                       placeholder="إسم الtag (عربي)" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" required name="title_en" class="form-control mb-2"
                                                       placeholder="إسم الtag (إنجليزي)" value=""/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="link" class="form-control mb-2"
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('admin.tags')}}" id="kt_ecommerce_add_product_cancel"
